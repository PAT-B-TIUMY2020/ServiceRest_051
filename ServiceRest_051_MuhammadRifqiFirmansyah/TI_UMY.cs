...
namespace ServiceRest_051_MuhammadRifqiFirmansyah
{
    ...
    public class TI_UMY : ITI_UMY
    {
        ...
        {
            string msg = "GAGAL";
            SqlConnection sqlcon = new SqlConnection("Data Source = DESKTOP-JUEID6K;Initial Catalog = TI UMY; Persist Security Info=True; User ID=sa;Password=firmansyah98");
        ...
        public List<Mahasiswa> GetAllMahasiswa()
        {
            ...
            SqlConnection con = new SqlConnection("Data Source=DESKTOP-JUEID6K;Initial Catalog=TI UMY;Persist Security Info=True;User ID=sa;Password=firmansyah98");
